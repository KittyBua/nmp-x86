...
FFMPEG_CONF_OPTS  += --enable-network
FFMPEG_CONF_OPTS  += --enable-nonfree
FFMPEG_CONF_OPTS  += --enable-zlib
FFMPEG_CONF_OPTS  += --enable-bzlib
FFMPEG_CONF_OPTS  += --enable-bsfs
#FFMPEG_CONF_OPTS  += --disable-xlib
#FFMPEG_CONF_OPTS  += --disable-libxcb
#FFMPEG_CONF_OPTS  += --disable-libxcb-shm
#FFMPEG_CONF_OPTS  += --disable-libxcb-xfixes
#FFMPEG_CONF_OPTS  += --disable-libxcb-shape
...
$(D)/ffmpeg: $(ARCHIVE)/ffmpeg-$(FFMPEG_VER).tar.bz2
	rm -rf cd $(SOURCE_DIR)/ffmpeg-$(FFMPEG_VER); \
	$(UNTAR)/ffmpeg-$(FFMPEG_VER).tar.bz2
	set -e; cd $(SOURCE_DIR)/ffmpeg-$(FFMPEG_VER); \
